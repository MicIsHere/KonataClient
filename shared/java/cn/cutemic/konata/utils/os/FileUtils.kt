...
import cn.cutemic.konata.modules.logger.Logger.info
...
object FileUtils {
    ...
    init {
        ...
        dir = file(ProviderManager.mcProvider.getGameDir(), "Konata " + Constants.VERSION)
        plugins = file(dir, "plugins")
        konataCache = file(cache, "KonataClient")
    ...
    fun saveTempValue(name: String, value: String) {
        val dir = File(konataCache, "$name.tmp")
