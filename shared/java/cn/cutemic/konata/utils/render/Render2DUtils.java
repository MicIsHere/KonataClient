package cn.cutemic.konata.utils.render;
...
import cn.cutemic.konata.utils.awt.RoundUtil;
import cn.cutemic.konata.wrapper.renderEngine.bufferbuilder.WrapperBufferBuilder;
...
public class Render2DUtils extends Utility {
    ...
    public static void drawOptimizedRoundedRect(float x, float y, float width, float height, int radius, int color) {
        ...
        drawImage(new ResourceLocation("konata/rounded/" + radius + "/lt.png"), x, y, radius, radius, color);
        drawImage(new ResourceLocation("konata/rounded/" + radius + "/rt.png"), x + width - radius, y, radius, radius, color);
        drawImage(new ResourceLocation("konata/rounded/" + radius + "/lb.png"), x, y + height - radius, radius, radius, color);
        drawImage(new ResourceLocation("konata/rounded/" + radius + "/rb.png"), x + width - radius, y + height - radius, radius, radius, color);
