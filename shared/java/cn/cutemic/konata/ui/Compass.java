    ...
    public void draw(ScaledResolution sr) {
        ...
        try {
            for (Degree d : degrees) {
                ...
                float completeLocation = d.type == 1 ? (location - Konata.fontManager.s28.getStringWidth(d.text) / 2f)
                        : d.type == 2 ? (location - Konata.fontManager.s28.getStringWidth(d.text) / 2f)
                        : (location - Konata.fontManager.s22.getStringWidth(d.text) / 2f);

                int opacity = opacity(sr, completeLocation);

                if (d.type == 1 && opacity != 16777215) {
                    GlStateManager.color(1, 1, 1, 1);
                    Konata.fontManager.s28.drawString(d.text, completeLocation, -75 + 100, opacity(sr, completeLocation));
                }
                ...
                if (d.type == 2 && opacity != 16777215) {
                    ...
                    GlStateManager.color(1, 1, 1, 1);
                    Konata.fontManager.s14.drawString(d.text, completeLocation, -75 + 105 + 3.5f + 4, opacity(sr, completeLocation));
                }

                if (d.type == 3 && opacity != 16777215) {
                    GlStateManager.color(1, 1, 1, 1);
                    Konata.fontManager.s22.drawString(d.text, completeLocation,
                            -75 + 100 + Konata.fontManager.s28.getHeight() / 2 - Konata.fontManager.s22.getHeight() / 2,
                            opacity(sr, completeLocation));
                }
            ...
            for (Degree d : degrees) {
                ...
                float location = center + (count * 30) - yaaahhrewindTime;
                float completeLocation = d.type == 1 ? (location - Konata.fontManager.s28.getStringWidth(d.text) / 2f)
                        : d.type == 2 ? (location - Konata.fontManager.s14.getStringWidth(d.text) / 2f)
                        : (location - Konata.fontManager.s22.getStringWidth(d.text) / 2f);
